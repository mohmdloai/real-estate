...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-w9i^8s+juav%v-l1=l!)#*7#ug$*&lu48$ia6ebdi8)439-62*')
...
DATABASES = {
    ...
    'users': {
        'ENGINE': os.getenv('USERS_DB_ENGINE'),
    ...
    'listings': {
        'ENGINE': os.getenv('LISTINGS_DB_ENGINE'),
        'NAME': os.getenv('LISTINGS_DB_NAME'),
